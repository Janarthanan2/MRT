...
export default function Admin({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="flex h-screen bg-stone-50 font-body overflow-hidden">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'w-56' : 'w-14'} flex-shrink-0 flex flex-col transition-all duration-200 overflow-y-auto overflow-x-hidden`} style={{ background: '#1C1308' }}>
        {/* Sidebar header */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <header className="bg-white border-b border-stone-200 px-6 py-3.5 flex items-center justify-between flex-shrink-0 shadow-sm">
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={onBack} className="text-xs font-medium px-3 py-1.5 rounded-lg border border-stone-200 text-stone-600 hover:bg-stone-50">
              ← Back to Store
            </button>
          </div>
        </header>
